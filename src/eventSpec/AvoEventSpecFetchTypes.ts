/**
 * This file is ported from js-avo-inspector for web/SSR/worker support.
 * Uses global fetch (available in browsers, workers, Node.js 18+).
 */
...
export interface EventSpecCacheEntry {
  /** The cached event specification response (internal format), or null for known-absent specs */
